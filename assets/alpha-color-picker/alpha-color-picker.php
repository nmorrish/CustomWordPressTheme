 ...
 * see github at https://github.com/BraadMartin/components/tree/master/customizer/alpha-color-picker
 */
class Customize_Alpha_Color_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script(
			'alpha-color-picker',
			get_stylesheet_directory_uri() . '/assets/alpha-color-picker/alpha-color-picker.js',
		...
		wp_enqueue_style(
			'alpha-color-picker',
			get_stylesheet_directory_uri() . '/assets/alpha-color-picker/alpha-color-picker.css',
